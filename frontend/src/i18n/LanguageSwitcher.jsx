...
const langs = [
  { code: 'gl', label: 'Galego', flag: '🇪🇸', color: 'border-blue-500 hover:bg-blue-600/20' },
  { code: 'es', label: 'Español', flag: '🇪🇸', color: 'border-yellow-500 hover:bg-yellow-600/20' },
  { code: 'en', label: 'English', flag: '🇬🇧', color: 'border-red-500 hover:bg-red-600/20' },
]
        ...
        <div className="flex gap-4">
          {langs.map(l => (
            <button key={l.code} onClick={() => handleSelect(l.code)}
              ...
              <span className={`text-sm font-bold ${current === l.code ? 'text-white' : 'text-slate-400'}`}>{l.label}</span>
