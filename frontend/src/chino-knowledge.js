...
- Semifinales UEFA Cup 2000 (eliminado por el Lens en la prórroga).
- Semifinales UEFA Cup 2001 (eliminado por el Liverpool en Anfield 1-0, gol de Gustavo López).
- Semifinales Europa League 2017 (eliminado por el United).
- Récord de imbatibilidad en casa: 13 partidos (2015-16).

### JUGADORES LEYENDA (datos clave)
- Iago Aspas (1987-): Máximo goleador histórico (200+ goles). Capitán. Mundial 2018.
- Alejandro Mostovoi (1968-): "O Zar". 72 goles. Genio ruso de los 90.
- Míchel Salgado (1975-): 290 partidos. Defensa internacional. Madridista pero celeste de corazón.
- Gustavo López (1973-): Mago argentino. Gol al Liverpool en Anfield 2001.
- Mazinho (1965-): Campeón del Mundo 1994 con Brasil. Centrocampista de seda.
- Patxi Salinas (1963-): 65 goles como delantero en los 80.
- Fernando Veloso (1952-): 240 partidos. Leyenda de los 70.
- Nolito (1986-): Extremo de la época dorada 2015-17. Internacional.
- Hicham Bouchama (1999-): Canterano con más futuro.
- Gabriel Alonso (1924-): Defensa de los 40 y 50. Campeón de Copa 1948.
...
- Años 70: Época de Veloso, consolidación en Primera.
- Años 90: "EuroCelta" con Mostovoi, Salgado, Mazinho, etc.
- Años 2010: Aspas, Nolito, Berizzo, semifinales Europa League.
- Actualidad 2026: Plantilla joven con identidad ofensiva.

### DATOS ÚNICOS
- El Celta es el equipo gallego más antiguo en Primera División.
- Iago Aspas es el máximo goleador histórico y también el máximo asistente.
- Balaídos fue el primer estadio de España con césped artificial (1982).
- La afición se llama "celeste" por el color azul celeste del escudo.
- El escudo tiene la Cruz de San Andrés (patrón de Vigo) y el Castillo.
- El himno oficial fue compuesto por Santiago y Juan.
- Capacidad de abonados 2026: más de 22.000.
- El club tiene más de 50 peñas oficiales repartidas por el mundo.
- Ciudad deportiva: A Madroa (desde 1995).
- Máxima goleada histórica: Celta 10-1 Gimnàstic (1940).
- Peor derrota: Real Madrid 9-1 Celta (1958).
- Mayor goleada en Europa: Celta 7-0 Lausanne (2000).
