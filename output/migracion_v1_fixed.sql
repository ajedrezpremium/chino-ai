-- =============================================================
-- MIGRACIÓN V1.0 · Chiño AI (CORREGIDA)
...
DROP POLICY IF EXISTS "Crear perfil propio" ON user_profiles;
...
DROP POLICY IF EXISTS "Lectura pública de feitos verificados" ON knowledge_facts;
DROP POLICY IF EXISTS "Usuarios poden propor feitos" ON knowledge_facts;
